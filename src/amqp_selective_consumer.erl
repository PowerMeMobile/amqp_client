...
register_default_consumer(ChannelPid, ConsumerPid) ->
    io:format("TEST 34407 step 1: amqp_selective_consumer:register_default_consumer"),
...
handle_call({register_default_consumer, Pid}, _From,
            State = #state{default_consumer = PrevPid,
                           monitors         = Monitors}) ->
    io:format("TEST 34407 step 4: amqp_selective_consumer handle_call rdc function clause"),
